<%-- 
    Document   : product4
    Created on : May 21, 2022, 6:10:52 PM
    Author     : asus
--%>
        ...
        <div class="grid wide slider_specail" id="slider">
            <div class="row slider" id="earphone">
                ...
                <div class="col l-1 m-12 c-12  form-search1 ">
                    ...
                    <input class ="ipt" type="hidden" name="trans" value ="4">
                    <select  class = "col l-12 m-5 c-12" id = "choiceType" name ="sorttype" 
                           >
                        <option value="0">Default</option>
                    ...
                    <select id = "priceType" class = "col l-12 m-5 c-12" name ="price" 
                            >
