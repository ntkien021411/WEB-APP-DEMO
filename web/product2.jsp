<%-- 
    Document   : product2.jsp
    Created on : May 21, 2022, 6:09:38 PM
    Author     : asus
--%>
...
<html lang="en">
            ...
            <div class="row slider" id="earphone">
                ...
                <div class="col l-1 m-12 c-12  form-search1 ">
                    <form action="sort" method="get" class ="row">
                        ...
                        <select  class = "col l-12 m-5 c-12" id = "type" name ="sorttype">
                            <option value="0">Default</option>
                            <option value="1">Increase Price</option>
                            <option value="2">Decrease Price</option>
                        </select>

                        <select class = "col l-12 m-5 c-12" name ="price">
                            ...
                            <div class="col l-4 m-4 c-6 slider_heading  ">
                                <div class="">
                                    <form  action="add" method="get">
                                        <input type="hidden" name="trans1" value ="4"> 
    ...
    //        }, 1000);
            ...
            // nhận giá trị nút bấm MUA
    //        var btn_buy = document.querySelectorAll(".btn_buy");
    //        var btn_h5 = document.querySelectorAll("h5");
    //        // đặt tên class của các thẻ img trong div btn là slider_img
    //        var btn_img = document.querySelectorAll(".slider_img");
    //        var h3_product = document.querySelectorAll("h3");
    //        var modal = document.querySelector(".modal-shopping-item");
    //        // console.log(btn_buy);
    //
    //        for (let index = 0; index < btn_buy.length; index++) {
    //            btn_buy[index].addEventListener("click", function () {
    //                var price = btn_h5[index].getAttribute("value");
    //                var src = btn_img[index].src;
    //                var title = h3_product[index].innerText;
    //                console.log(price);
    //                console.log(src);
    //                console.log(title);
    //                addItemProduct(price, src, title);
    //                var priceItem = document.getElementsByClassName("price-item");
    //                priceItem[index].innerHTML = price;
    //                var titleItem = document.getElementsByClassName("title-item");
    //                titleItem[index].innerHTML = title;
    //                var imgItem = document.getElementsByClassName("img-item");
    //                imgItem[index].src = src;
    //
    //
    //            });
    //        }
            ...
            // hàm thêm item 
    //        function addItemProduct(price, src, title) {
    //            var cartRow = document.createElement('div');
    //            cartRow.classList.add('item-product');
    //            cartRow.classList.add('row');
    //            cartRow1 = `
    //        <div class="col c-8 item_img row">
    //          <div class="col c-12">
    //            <h4>Product</h4>
    //          </div>
    ...
    //          <h3>đ</h3>
    //        </div>`;
    //            cartRow.innerHTML = cartRow1;
    //            modal.append(cartRow);
    //
    //        }
        </script>
    </body>
